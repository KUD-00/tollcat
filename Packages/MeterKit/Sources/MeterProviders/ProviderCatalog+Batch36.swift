...
extension ProviderCatalog {
    public static let fiskil = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.fiskil.com/data-api/api-reference/getEnergyInvoices")!,
    ...
    public static let pleo = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://developers.pleo.io/reference/accounting-entries/v1/search-accounting-entries")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
