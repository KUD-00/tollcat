...
extension ProviderCatalog {
    public static let zilliz = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.zilliz.com/docs/api-keys")!,
    ...
    public static let glesys = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://github.com/glesys/api-docs/wiki/API-Documentation#invoicelist")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
    ...
    public static let cloudsigma = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.cloudsigma.com/en/latest/billing.html")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
