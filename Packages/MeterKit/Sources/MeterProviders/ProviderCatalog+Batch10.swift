...
extension ProviderCatalog {
    ...
    public static let prodigi = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.prodigi.com/print-api/docs/reference/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let mysendingbox = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.mysendingbox.fr/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let stannp = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.stannp.com/us/direct-mail-api/accounts")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let phaxio = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.phaxio.com/docs/api/v2/account/get_status")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let porkbun = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://porkbun.com/api/json/v3/documentation")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let namecheap = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.namecheap.com/support/api/intro/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let gandi = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://api.gandi.net/docs/authentication/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
