...
extension ProviderCatalog {
    public static let shippo = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://portal.goshippo.com/api-config/api")!,
    ...
    public static let printful = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://developers.printful.com/tokens")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let gooten = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.gooten.com/admin#/settings/api")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let easyship = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://app.easyship.com/connect")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
    ...
    public static let huaweicloud = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://support.huaweicloud.com/intl/en-us/api-iam/iam_30_0001.html")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        accessStatus: .pendingVerification,
