...
extension ProviderCatalog {
    ...
    public static let mikrocloud = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://mikrocloud.com/documentation/api-reference/authentication")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let leaseweb = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://kb.leaseweb.com/kb/customer-portal-api/customer-portal-api-api-key-management/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
    ...
    public static let qovery = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.qovery.com/docs/configuration/organization/api-token")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let phoenixnap = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://phoenixnap.com/kb/bare-metal-cloud-portal-quick-start-guide")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let magalucloud = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://id.magalu.com/api-keys")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let transip = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.transip.nl/cp/account/api/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let serverscom = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://portal.servers.com/iam/api-tokens")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let flexport = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://developers.flexport.com/tutorials/using-api-credentials/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let i3dnet = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://one.i3d.net/Account/API-Keys")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let datapacket = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://app.datapacket.com/settings/security#api-keys")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let cudocompute = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://compute.cudo.org")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let shipwell = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://app.shipwell.com/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let ocamba = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.ocamba.com/user/core/core-platform-settings/api-tokens/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
