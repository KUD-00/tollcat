...
extension ProviderCatalog {
    public static let inferencesh = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://inference.sh/docs/api/rest/usage")!,
    ...
    public static let voltview = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.voltview.co.uk/api-reference/sites/invoices-for-all-sites")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
