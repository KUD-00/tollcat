...
extension ProviderCatalog {
    public static let azion = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://console.azion.com")!,
    ...
    public static let elastx = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.elastx.cloud/docs/openstack-iaas/guides/application_credentials/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
    ...
    public static let warpstream = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.warpstream.com/warpstream/reference/secrets-overview")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let digicert = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://dev.digicert.com/certcentral-apis/authentication.html")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let deel = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://developer.deel.com/api/authentication")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let remote = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://developer.remote.com/docs/authorization-for-customers")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let oyster = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.oysterhr.com/docs/customer-guide-to-creating-and-authorizing-a-developer-application")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let outscale = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.outscale.com/en/userguide/Creating-an-Access-Key.html")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let orangecloud = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://developer.orange.com/myapps")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
        ...
        guideURLs: [
            "findContractID": URL(
                string: "https://cloud.orange-business.com/wp-content/uploads/2025/01/CloudCustomerSpace_api-POSTMAN-COLLECTION-USER-GUIDE-EN.pdf"
            )!,
        ]
    )
    ...
    public static let gridscale = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://my.gridscale.io/APIKey")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
    ...
    public static let rackspace = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.rackspace.com/docs/view-and-reset-your-api-key")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 1,
        accessStatus: .pendingVerification,
        ...
        guideURLs: [
            "findAccountNumber": URL(
                string: "https://docs.rackspace.com/reference/offerings-get-your-credentials"
            )!,
        ]
    )
    ...
    public static let pika = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://dev.pika.art/keys")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
    ...
    public static let hedra = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.hedra.com/develop/api-keys")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 3,
        accessStatus: .pendingVerification,
    ...
    public static let tidbcloud = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.pingcap.com/tidbcloud/api/v1beta1/serverless")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
    ...
    public static let hyperstack = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://console.hyperstack.cloud/api-keys")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 3,
        accessStatus: .pendingVerification,
    ...
    public static let memset = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.memset.com/apidocs/intro.html")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let mittwald = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://studio.mittwald.de/app/profile/api-tokens")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let soracom = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://developers.soracom.io/en/docs/security/authkeys")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
    ...
    public static let starlink = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.starlink.com/account/settings")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let tibber = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://developer.tibber.com/settings/access-token")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let once = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://portal.1nce.com/portal/customer/users")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let octopusenergy = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://octopus.energy/dashboard/new/accounts/personal-details")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let pge = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://sharemydata.pge.com/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let coned = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.coned.com/en/accounts-billing/share-energy-usage-data/become-a-third-party")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let dynatrace = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.dynatrace.com/docs/manage/identity-access-management/access-tokens-and-oauth-clients/oauth-clients")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let zoom = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://marketplace.zoom.us/develop/create")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let namecom = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://www.name.com/account/settings/api")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let ovhcloud = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://eu.api.ovh.com/createToken/")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: true,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let sakuracloud = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://manual.sakura.ad.jp/cloud/api/apikey.html")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
    ...
    public static let akamai = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://control.akamai.com/apps/identity-management/#/tabs/users/list")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 12,
        accessStatus: .pendingVerification,
