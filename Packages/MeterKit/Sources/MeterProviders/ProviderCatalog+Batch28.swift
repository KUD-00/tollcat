...
extension ProviderCatalog {
    public static let ncloud = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://api.ncloud-docs.com/docs/en/platform-costandusage-getdemandcostlist")!,
    ...
    public static let nomos = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://docs.nomos.energy/api-reference/invoices/list-invoices")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
    ...
    public static let dnscale = ProviderDescriptor(
        ...
        credentialSetupURL: URL(string: "https://dnscale.eu/api/billing")!,
        costsMoneyToRefresh: false,
        supportsDailyGranularity: false,
        historyLookbackMonths: 24,
        accessStatus: .pendingVerification,
